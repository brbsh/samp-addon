...
public:
    ...
    ProxyIDirect3DDevice9(IDirect3DDevice9* _original, UINT _adapter, D3DDEVTYPE _deviceType, HWND _focusWindow, DWORD _behaviorFlags, D3DPRESENT_PARAMETERS* _presentationParameters);
	...
	IDirect3DDevice9* GetRealDevice() const { return original; }
